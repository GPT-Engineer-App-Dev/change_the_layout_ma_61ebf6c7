...
const Index = () => {
  ...
  const calculateFare = () => {
    ...
    setFareBreakdown({
      startFare: `£${startFare.toFixed(2)}`,
      distanceFare: `£${distanceFare.toFixed(2)}`,
      additionalPassengersFare: `£${additionalPassengersFare.toFixed(2)}`,
      childrenFare: `£${childrenFare.toFixed(2)}`,
      luggageFare: `£${luggageFare.toFixed(2)}`,
      cyclesFare: `£${cyclesFare.toFixed(2)}`,
      waitingTimeFare: `£${waitingTimeFare.toFixed(2)}`,
    });
          ...
          <GridItem>
            <Box bg="white" p={6} borderRadius="md" boxShadow="md">
              ...
              <VStack align="stretch" mt={8}>
                ...
                <Text fontSize="sm">Start Fare: {fareBreakdown.startFare}</Text>
                <Text fontSize="sm">Distance Fare: {fareBreakdown.distanceFare}</Text>
                <Text fontSize="sm">Additional Passengers: {fareBreakdown.additionalPassengersFare}</Text>
                <Text fontSize="sm">Children: {fareBreakdown.childrenFare}</Text>
                <Text fontSize="sm">Luggage: {fareBreakdown.luggageFare}</Text>
                <Text fontSize="sm">Cycles: {fareBreakdown.cyclesFare}</Text>
                <Text fontSize="sm">Waiting Time: {fareBreakdown.waitingTimeFare}</Text>
              </VStack>
            </Box>
          </GridItem>
        </Grid>
